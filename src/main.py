...
def main():
    ...
    # routes
    routes.append(Route(1, [edges[ 1], edges[ 8], edges[ 4]])) # straight from south
    routes.append(Route(2, [edges[ 1], edges[ 9], edges[ 2]])) # right from south
    routes.append(Route(3, [edges[ 1], edges[10], edges[ 6]])) # left from south

    routes.append(Route(4, [edges[ 3], edges[11], edges[ 6]])) # straight from east
    routes.append(Route(5, [edges[ 3], edges[12], edges[ 4]])) # right from east
    routes.append(Route(6, [edges[ 3], edges[13], edges[ 0]])) # left from east

    routes.append(Route(7, [edges[ 5], edges[14], edges[ 0]])) # straight from north
    routes.append(Route(8, [edges[ 5], edges[15], edges[ 6]])) # right from north
    routes.append(Route(9, [edges[ 5], edges[16], edges[ 2]])) # left from north

    routes.append(Route(10, [edges[ 7], edges[17], edges[ 2]])) # straight from west
    routes.append(Route(11, [edges[ 7], edges[18], edges[ 0]])) # right from west
    routes.append(Route(12, [edges[ 7], edges[19], edges[ 4]])) # left from west
